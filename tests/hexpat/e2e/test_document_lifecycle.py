...
class TestDocumentCreation:
    ...
    def test_empty_doc_has_zero_length(self, empty_doc: HexDocument) -> None:
    ...
    def test_open_bytes_creates_doc_with_correct_length(self, hexcore: types.ModuleType, sample_bytes: bytes) -> None:
    ...
    def test_open_bytes_content_matches_input(self, hexcore: types.ModuleType, sample_bytes: bytes) -> None:
    ...
    def test_open_from_file_has_correct_length(self, sample_doc: HexDocument, sample_bytes: bytes) -> None:
    ...
    def test_open_from_file_content_matches_file(self, sample_doc: HexDocument, sample_bytes: bytes) -> None:
    ...
    def test_in_memory_doc_file_path_is_none(self, sample_doc_from_bytes: HexDocument) -> None:
    ...
    def test_file_opened_doc_returns_path(self, hexcore: types.ModuleType, tmp_path: Path, sample_bytes: bytes) -> None:
    ...
    def test_empty_doc_file_path_is_none(self, empty_doc: HexDocument) -> None:
    ...
    def test_open_nonexistent_file_raises(self, hexcore: types.ModuleType, tmp_path: Path) -> None:
    ...
    def test_open_empty_file_succeeds_with_zero_length(self, hexcore: types.ModuleType, tmp_path: Path) -> None:
...
class TestDocumentSave:
    ...
    def test_save_writes_correct_content_to_disk(self, hexcore: types.ModuleType, tmp_path: Path, sample_bytes: bytes) -> None:
    ...
    def test_save_as_creates_new_file(self, sample_doc: HexDocument, tmp_path: Path, sample_bytes: bytes) -> None:
    ...
    def test_is_modified_false_after_save(self, hexcore: types.ModuleType, tmp_path: Path, sample_bytes: bytes) -> None:
    ...
    def test_save_then_reopen_preserves_data(self, hexcore: types.ModuleType, tmp_path: Path, sample_bytes: bytes) -> None:
    ...
    def test_save_as_original_unchanged(self, hexcore: types.ModuleType, tmp_path: Path, sample_bytes: bytes) -> None:
