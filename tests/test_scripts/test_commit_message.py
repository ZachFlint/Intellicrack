...
def _reference_token_count(text: str) -> int:
    """Count tokens with an independent BPE tokenizer (tiktoken).
...
class TestCountTokensFallback:
    ...
    def test_server_error_falls_back_to_estimate(self) -> None:
        """Verify a real ``ServerError`` (503) routes to the estimate."""
        text = "a" * 300
    ...
    def test_client_error_falls_back_to_estimate(self) -> None:
        """Verify a real ``ClientError`` (400) routes to the estimate."""
        text = "b" * 600
    ...
    def test_connection_error_falls_back_to_estimate(self) -> None:
        """Verify a real ``ConnectionError`` routes to the estimate."""
        text = "c" * 900
