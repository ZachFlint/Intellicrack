...
class TestGetPatches:
    ...
    def test_unmodified_doc_returns_empty_patch_list(self, sample_doc_from_bytes: Any) -> None:
    ...
    def test_patch_list_entries_are_two_tuples(self, sample_doc_from_bytes: Any) -> None:
...
class TestIPSExport:
    ...
    def test_ips_export_starts_with_patch_magic(self, sample_doc_from_bytes: Any) -> None:
    ...
    def test_ips_export_ends_with_eof_magic(self, sample_doc_from_bytes: Any) -> None:
    ...
    def test_ips_export_returns_bytes(self, sample_doc_from_bytes: Any) -> None:
    ...
    def test_ips_export_minimum_size_with_one_patch(self, sample_doc_from_bytes: Any) -> None:
...
class TestIPS32Export:
    ...
    def test_ips32_export_starts_with_ips32_magic(self, sample_doc_from_bytes: Any) -> None:
    ...
    def test_ips32_export_ends_with_eeof_magic(self, sample_doc_from_bytes: Any) -> None:
    ...
    def test_ips32_export_returns_bytes(self, sample_doc_from_bytes: Any) -> None:
...
class TestIPSRoundtrip:
    ...
    def test_ips_roundtrip_single_patch(self, hexcore: Any, sample_bytes: bytes) -> None:
    ...
    def test_ips_roundtrip_preserves_unpatched_bytes(self, hexcore: Any, sample_bytes: bytes) -> None:
    ...
    def test_ips_roundtrip_multi_patch(self, hexcore: Any, sample_bytes: bytes) -> None:
...
class TestIPSImport:
    ...
    def test_import_ips_returns_patch_count(self, hexcore: Any, sample_bytes: bytes) -> None:
    ...
    def test_import_ips_raises_on_invalid_data(self, sample_doc_from_bytes: Any) -> None:
