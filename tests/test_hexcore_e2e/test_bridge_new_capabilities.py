...
class TestEncodeText:
    ...
    def test_encode_ascii_returns_hex_string(self, bridge: Any, tmp_path: Path) -> None:
    ...
    def test_encode_utf8_multibyte(self, bridge: Any, tmp_path: Path) -> None:
    ...
    def test_encode_utf16le_bom_aware(self, bridge: Any, tmp_path: Path) -> None:
    ...
    def test_encode_decode_roundtrip(self, bridge: Any, tmp_path: Path) -> None:
    ...
    def test_encode_text_raises_without_document(self, bridge: Any) -> None:
...
class TestSearchBytes:
    ...
    def test_search_bytes_finds_mz_header(self, loaded_bridge: Any) -> None:
    ...
    def test_search_bytes_result_has_correct_length(self, loaded_bridge: Any) -> None:
    ...
    def test_search_bytes_with_spaces_in_hex(self, loaded_bridge: Any) -> None:
    ...
    def test_search_bytes_no_match_returns_empty(self, loaded_bridge: Any) -> None:
    ...
    def test_search_bytes_raises_without_document(self, bridge: Any) -> None:
    ...
    def test_search_bytes_finds_embedded_pattern(self, bridge: Any, tmp_path: Path) -> None:
...
class TestSearchNumericRange:
    ...
    def test_range_search_finds_values_in_range(self, bridge: Any, tmp_path: Path) -> None:
    ...
    def test_range_search_signed_integers(self, bridge: Any, tmp_path: Path) -> None:
    ...
    def test_range_search_big_endian(self, bridge: Any, tmp_path: Path) -> None:
    ...
    def test_range_search_alignment(self, bridge: Any, tmp_path: Path) -> None:
    ...
    def test_range_search_raises_without_document(self, bridge: Any) -> None:
...
class TestSearchTextEncodedPreference:
    ...
    def test_search_text_finds_ascii_in_binary(self, bridge: Any, tmp_path: Path) -> None:
    ...
    def test_search_text_utf16le(self, bridge: Any, tmp_path: Path) -> None:
...
class TestDeadCodeRemoval:
    ...
    def test_ips_patch_roundtrip(self, bridge: Any, tmp_path: Path) -> None:
...
class TestNumericSearchWorkerDispatch:
    ...
    def test_search_numeric_exact_match(self, bridge: Any, tmp_path: Path) -> None:
...
class TestProcessMemoryBridge:
    ...
    def test_list_process_regions_returns_list(self, bridge: Any) -> None:
    ...
    @pytest.mark.skipif(os.name != "nt", reason="Windows-only process memory API")
    def test_list_process_regions_has_committed_regions(self, bridge: Any) -> None:
    ...
    @pytest.mark.skipif(os.name != "nt", reason="Windows-only process memory API")
    def test_open_process_memory_allows_read(self, bridge: Any) -> None:
