...
class TestDocumentCreation:
    ...
    def test_open_bytes_creates_doc_with_correct_length(
    ...
    def test_open_bytes_content_matches_input(
        self, hexcore: Any, sample_bytes: bytes
    ) -> None:
    ...
    def test_open_from_file_has_correct_length(
    ...
    def test_open_from_file_content_matches_file(
        self, sample_doc: Any, sample_bytes: bytes
    ) -> None:
    ...
    def test_in_memory_doc_file_path_is_none(
    ...
    def test_file_opened_doc_returns_path(
        self, hexcore: Any, tmp_path: Path, sample_bytes: bytes
    ) -> None:
    ...
    def test_open_empty_file_succeeds_with_zero_length(
...
class TestDocumentSave:
    ...
    def test_save_writes_correct_content_to_disk(
        self, hexcore: Any, tmp_path: Path, sample_bytes: bytes
    ) -> None:
    ...
    def test_save_as_creates_new_file(
        self, sample_doc: Any, tmp_path: Path, sample_bytes: bytes
    ) -> None:
    ...
    def test_is_modified_false_after_save(
        self, hexcore: Any, tmp_path: Path, sample_bytes: bytes
    ) -> None:
    ...
    def test_save_then_reopen_preserves_data(
        self, hexcore: Any, tmp_path: Path, sample_bytes: bytes
    ) -> None:
    ...
    def test_save_as_original_unchanged(
        self, hexcore: Any, tmp_path: Path, sample_bytes: bytes
    ) -> None:
