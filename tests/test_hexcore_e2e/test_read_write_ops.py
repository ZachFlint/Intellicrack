...
class TestReadOps:
    ...
    def test_read_returns_correct_bytes_at_offset(
        self, sample_doc: Any, sample_bytes: bytes
    ) -> None:
    ...
    def test_read_byte_returns_correct_single_byte(
        self, sample_doc: Any, sample_bytes: bytes
    ) -> None:
    ...
    def test_read_at_offset_zero_full_length(
        self, sample_doc: Any, sample_bytes: bytes
    ) -> None:
    ...
    def test_read_across_byte_boundaries(
        self, sample_doc: Any, _sample_bytes: bytes
    ) -> None:
    ...
    def test_read_single_byte_via_read(
        self, sample_doc: Any, sample_bytes: bytes
    ) -> None:
...
class TestWriteOps:
    ...
    def test_write_bytes_overwrites_correctly(
    ...
    def test_write_then_read_back_verifies_data(
        self, sample_doc_from_bytes: Any
    ) -> None:
    ...
    def test_write_does_not_change_surrounding_bytes(
    ...
    def test_write_at_end_of_document(
        self, sample_doc_from_bytes: Any, sample_bytes: bytes
    ) -> None:
    ...
    def test_write_marks_document_as_modified(
        self, sample_doc_from_bytes: Any
    ) -> None:
...
class TestInsertOps:
    ...
    def test_insert_at_beginning_shifts_data(
        self, sample_doc_from_bytes: Any, sample_bytes: bytes
    ) -> None:
    ...
    def test_insert_in_middle_preserves_surrounding_data(
        self, sample_doc_from_bytes: Any, sample_bytes: bytes
    ) -> None:
        ...
        assert (
            sample_doc_from_bytes.read(insert_at, 2) == insertion
        )
        assert (
            sample_doc_from_bytes.read(insert_at + 2, 5) == sample_bytes[insert_at : insert_at + 5]
        )
...
class TestDeleteOps:
    ...
    def test_delete_decreases_length(
        self, sample_doc_from_bytes: Any, sample_bytes: bytes
    ) -> None:
    ...
    def test_delete_from_beginning_exposes_next_bytes(
        self, sample_doc_from_bytes: Any, sample_bytes: bytes
    ) -> None:
    ...
    def test_delete_from_middle_preserves_surrounding_data(
        self, sample_doc_from_bytes: Any, sample_bytes: bytes
    ) -> None:
        ...
        assert (
            sample_doc_from_bytes.read(delete_at, 4)
            == sample_bytes[delete_at + delete_len : delete_at + delete_len + 4]
        )

    def test_delete_marks_document_as_modified(
        self, sample_doc_from_bytes: Any
    ) -> None:
