...
class TestHashAlgorithms:
    ...
    def test_md5_matches_hashlib(self, sample_doc_from_bytes: Any, sample_bytes: bytes) -> None:
    ...
    def test_sha1_matches_hashlib(self, sample_doc_from_bytes: Any, sample_bytes: bytes) -> None:
    ...
    def test_sha256_matches_hashlib(self, sample_doc_from_bytes: Any, sample_bytes: bytes) -> None:
    ...
    def test_sha512_matches_hashlib(self, sample_doc_from_bytes: Any, sample_bytes: bytes) -> None:
    ...
    def test_crc32_matches_binascii(self, sample_doc_from_bytes: Any, sample_bytes: bytes) -> None:
    ...
    def test_sha3_256_matches_hashlib_if_supported(self, sample_doc_from_bytes: Any, sample_bytes: bytes) -> None:
    ...
    def test_sha3_512_matches_hashlib_if_supported(self, sample_doc_from_bytes: Any, sample_bytes: bytes) -> None:
    ...
    def test_blake2b_matches_hashlib_if_supported(self, sample_doc_from_bytes: Any, sample_bytes: bytes) -> None:
    ...
    def test_unsupported_algorithm_raises(self, sample_doc_from_bytes: Any) -> None:
    ...
    def test_sha256_output_is_64_hex_chars(self, sample_doc_from_bytes: Any) -> None:
    ...
    def test_md5_output_is_32_hex_chars(self, sample_doc_from_bytes: Any) -> None:
    ...
    def test_sha1_output_is_40_hex_chars(self, sample_doc_from_bytes: Any) -> None:
    ...
    def test_sha512_output_is_128_hex_chars(self, sample_doc_from_bytes: Any) -> None:
...
class TestHashRange:
    ...
    def test_full_range_equals_full_hash(self, sample_doc_from_bytes: Any) -> None:
    ...
    def test_subrange_matches_hashlib_slice(self, sample_doc_from_bytes: Any, sample_bytes: bytes) -> None:
    ...
    def test_single_byte_range(self, sample_doc_from_bytes: Any, sample_bytes: bytes) -> None:
    ...
    def test_range_md5_matches_hashlib(self, sample_doc_from_bytes: Any, sample_bytes: bytes) -> None:
    ...
    def test_range_sha512_matches_hashlib(self, sample_doc_from_bytes: Any, sample_bytes: bytes) -> None:
    ...
    def test_different_ranges_produce_different_hashes(self, sample_doc_from_bytes: Any) -> None:
...
class TestCustomCRC:
    ...
    def test_crc32_standard_matches_binascii(self, sample_doc_from_bytes: Any, sample_bytes: bytes) -> None:
    ...
    def test_crc32_standard_subrange_matches_binascii(self, sample_doc_from_bytes: Any, sample_bytes: bytes) -> None:
        ...
        expected: str = f"{crc_val:08x}"
        result: str = sample_doc_from_bytes.compute_hash_custom_crc(start, end, 0x04C11DB7, 0xFFFFFFFF, 32, True, True, 0xFFFFFFFF)
        assert result.lower() == expected.lower()

    def test_crc16_arc_matches_reference_implementation(self, sample_doc_from_bytes: Any, sample_bytes: bytes) -> None:
        ...
        result: str = sample_doc_from_bytes.compute_hash_custom_crc(0, doc_length, 0x8005, 0x0000, 16, True, True, 0x0000)
        assert result.lower() == expected.lower()

    def test_crc16_arc_subrange_matches_reference(self, sample_doc_from_bytes: Any, sample_bytes: bytes) -> None:
    ...
    def test_crc32_output_format_is_hex_string(self, sample_doc_from_bytes: Any) -> None:
    ...
    def test_crc32_single_byte_range(self, sample_doc_from_bytes: Any, sample_bytes: bytes) -> None:
        ...
        expected: str = f"{crc_val:08x}"
        result: str = sample_doc_from_bytes.compute_hash_custom_crc(offset, offset + 1, 0x04C11DB7, 0xFFFFFFFF, 32, True, True, 0xFFFFFFFF)
        assert result.lower() == expected.lower()

    def test_different_ranges_produce_different_crcs(self, sample_doc_from_bytes: Any) -> None:
        """Verify that two distinct sub-ranges produce different CRC-32 values.

        Args:
            sample_doc_from_bytes: HexDocument created from sample_bytes.
        """
        crc_a: str = sample_doc_from_bytes.compute_hash_custom_crc(0, 64, 0x04C11DB7, 0xFFFFFFFF, 32, True, True, 0xFFFFFFFF)
        crc_b: str = sample_doc_from_bytes.compute_hash_custom_crc(64, 128, 0x04C11DB7, 0xFFFFFFFF, 32, True, True, 0xFFFFFFFF)
        assert crc_a != crc_b
