...
class TestBridgeDisassembly:
    ...
    def test_disassemble_returns_list(
        ...
        result: list[dict[str, Any]] = _run(
            bridge.disassemble(0, count=4, arch="x86", mode="64")
        )
        assert isinstance(result, list)

    def test_disassemble_int3_mnemonic(
        self, bridge: Any, tmp_path: Path
    ) -> None:
    ...
    def test_disassemble_result_items_have_required_keys(
        self, bridge: Any, tmp_path: Path
    ) -> None:
    ...
    def test_disassemble_instruction_address_starts_at_offset(
        self, bridge: Any, tmp_path: Path
    ) -> None:
    ...
    def test_disassemble_nop_has_size_one(
        self, bridge: Any, tmp_path: Path
    ) -> None:
    ...
    def test_disassemble_bytes_field_is_hex_string(
        self, bridge: Any, tmp_path: Path
    ) -> None:
    ...
    def test_disassemble_pe_section_code_with_auto_arch(
        ...
        """
        result: list[dict[str, Any]] = _run(
            loaded_bridge.disassemble(0x200, count=4, arch="auto")
        )
        assert isinstance(result, list)
