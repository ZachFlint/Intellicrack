...
class TestCompilePattern:
    ...
    def test_compile_simple_struct_returns_nonempty_string(
        self, bridge: Any
    ) -> None:
    ...
    def test_compile_simple_struct_result_is_valid_json(
        self, bridge: Any
    ) -> None:
    ...
    def test_compile_syntax_error_raises_value_error(
        self, bridge: Any
    ) -> None:
    ...
    def test_compile_complex_struct_with_nested_types_is_valid_json(
        self, bridge: Any
    ) -> None:
        ...
        """
        source = (
            "struct Inner { u8 tag; u16 val; };"
            "struct Outer { u32 hdr; Inner sub; };"
        )
        result: str = _run(bridge.compile_pattern(source))
        parsed = json.loads(result)
        assert isinstance(parsed, dict)
...
class TestExecutePattern:
    ...
    def test_execute_u32_field_returns_field_list(
    ...
    def test_execute_u32_field_has_correct_size(
        self, bridge: Any, tmp_path: Path
    ) -> None:
    ...
    def test_execute_u32_field_has_correct_offset(
        self, bridge: Any, tmp_path: Path
    ) -> None:
    ...
    def test_execute_struct_with_multiple_fields_returns_multiple_results(
        self, bridge: Any, tmp_path: Path
    ) -> None:
        ...
        _make_pattern_file(tmp_path, bridge)
        source = (
            "struct Header { u16 magic; u32 value; };"
            "Header header @ 0x00;"
        )
        fields: list[dict[str, Any]] = _run(bridge.execute_pattern(source))
        assert len(fields) >= 1
    ...
    def test_execute_at_nonzero_offset(
        self, bridge: Any, tmp_path: Path
    ) -> None:
    ...
    def test_execute_pattern_field_has_required_keys(
        self, bridge: Any, tmp_path: Path
    ) -> None:
    ...
    def test_execute_pattern_with_no_document_raises_runtime_error(
        self, bridge: Any
    ) -> None:
    ...
    def test_execute_u16_field_correct_size(
        self, bridge: Any, tmp_path: Path
    ) -> None:
...
class TestExecutePatternFile:
    ...
    def test_execute_pattern_file_matches_inline_result(
        self, bridge: Any, tmp_path: Path
    ) -> None:
        ...
        file_fields: list[dict[str, Any]] = _run(
            bridge.execute_pattern_file(str(pat_file))
        )
        assert len(file_fields) == len(inline_fields)

    def test_execute_pattern_file_nonexistent_raises_file_not_found(
        self, bridge: Any, tmp_path: Path
    ) -> None:
    ...
    def test_execute_pattern_file_with_no_document_raises_runtime_error(
        self, bridge: Any, tmp_path: Path
    ) -> None:
    ...
    def test_execute_pattern_file_field_has_required_keys(
        self, bridge: Any, tmp_path: Path
    ) -> None:
...
class TestListAndAutoDetect:
    ...
    def test_list_hexpat_patterns_items_have_required_keys(
        self, bridge: Any
    ) -> None:
    ...
    def test_auto_detect_with_no_document_raises_runtime_error(
        self, bridge: Any
    ) -> None:
    ...
    def test_auto_detect_with_pe_file_returns_list(
