...
Provides a QMainWindow wrapper that hosts a panel widget detached
from the main ToolOutputPanel tab container, allowing panels to
float independently, be moved to secondary monitors, and be
re-docked back into the tab bar.
"""
